...
<template>
  <div class="fixed w-full h-screen bg-black">
    ...
    <div v-if="!showFullVideo">
      ...
      >
        <div
          class="absoulute z-30 h-[600px] left-[120px] w-[77%] right-0 top-0 bg-gradient-to-r from-black via-black"
        />
      ...
      <div class="fixed z-30 bottom-0 right-0 w-full h-[55%] pl-[120px] overflow-y-auto">
        <VideoCarousel
          class="pb-14 pt-14"
          category="Popüler Filmler"
          :movies="movies[0]"
        />
        <VideoCarousel class="pb-14" category="Korku Filmi" :movies="movies[1]" />
        <VideoCarousel class="pb-32" category="Gelecek Filmler" :movies="movies[2]" />
      </div>
    </div>
